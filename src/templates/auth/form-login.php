...
do_action( 'trustedlogin/auth/page_header' ); ?>
...
<form method="post" class="tl-auth-login">
	...
	<p class="tl-auth-actions">
		...
		<button type="submit" class="button button-large button-primary tl-auth-login-button" name="login" value="<?php esc_attr_e( 'Login', 'woocommerce' ); ?>"><?php esc_html_e( 'Login', 'woocommerce' ); ?></button>
