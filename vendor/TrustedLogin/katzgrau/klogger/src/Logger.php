...
use TrustedLogin\Psr\Log\AbstractLogger;
use TrustedLogin\Psr\Log\LogLevel;
 ...
 *
 * Usage:
 * $log = new Katzgrau\KLogger\Logger('/var/log/', TrustedLogin\Psr\Log\LogLevel::INFO);
 ...
 * Class documentation
 */
class TrustedLogin_Logger extends AbstractLogger
{
    /**
     * KLogger options
